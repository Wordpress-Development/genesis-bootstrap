...
// ADD BOOTSTRAP SIDEBAR WIDGET CLASSES
if ( ! function_exists( 'gb3_register_sidebar_defaults' ) ) {
...
function gb3_genesis_edit_widget_areas() {
	add_filter( 'genesis_register_widget_area_defaults', 'gb3_register_sidebar_defaults');
}
add_action( 'genesis_setup', 'gb3_genesis_edit_widget_areas', 15 );
