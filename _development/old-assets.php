...
function bsg_load_bootstrap_stylesheet() {
    ...
    if ( $stylesheet ) {
        wp_enqueue_style( 'bsg-bootstrap-css', $stylesheet, array(), false );
    ...
    wp_enqueue_style( 'bsg-font-awesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css', array(), false );
